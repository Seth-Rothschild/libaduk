...
<main class="page-menu">
  ...
  <div class="page-menu__content box box-pad">
    ...
    <details class="question" name="faq">
      ...
      <div class="answer">
        <p>
          ...
          software (<a href="https://en.wikipedia.org/wiki/GNU_Affero_General_Public_License"
            >AGPL</a
          >
    ...
    <details class="question" name="faq">
      ...
      <div class="answer">
        <p>
          ...
          as good. At the current cost of operating the site, I'll be able to run it out-of-pocket for
          a long time.
        </p>
        <p>
          The most helpful thing you can do for Libaduk is to tell me about where the user
          experience is bad or could be better. You can ping me in the <a href="/tv">chat</a> room,
          or write an
    ...
    <details class="question" name="faq">
      ...
      <div class="answer">
        <p>
          Nope! The community of players that plays go online is small and does not need to be
          split.
        </p>
        <p>
          I do not want to create a replacement for any of the large servers or to have explosive
          user growth. If you're looking for a western site with a large user base, you're probably
          looking for <a href="https://online-go.com/">OGS</a>. You can use that OGS account for
          some quick play functionality here, but I have no plans to implement a ranking system or
          recruit large groups of users over to this site.
        </p>
        <p>
    ...
    <details class="question" name="faq">
      ...
      <div class="answer">
        <p>
          Mostly not! The majority of the site will work just fine whether or not you have an
          account. You can <a href="/?setup=hook">create games</a>, collaborate with others in the
        ...
        <ol>
          ...
          <li>
            For correspondence games it would be wise to create a real account. The site tries to
            give you a consistent Guest ID, but if that ID changes for any reason you'll lose the
            ability to play moves in your own game.
          </li>
        </ol>
      </div>
    </details>
    ...
    <details class="question" name="faq">
      ...
      <div class="answer">
        ...
        <p>
          ...
          <a href="https://github.com/SabakiHQ/Sabaki/tree/master">Sabaki</a> to grab Go board design
          and implementation. This has created an absurd amount of tech debt, which might or might not
          have been worthwhile. While the code isn't to the quality where I would personally like it,
          this approach got me to a working Go site that looks like Lichess, which I've tried to do a
          few times in the past without success.
        </p>
        <p>
    ...
    <details class="question" name="faq">
      ...
      <div class="answer">
        <p>
          ...
          review. While AI can help find "more correct" moves, it provides a negative pressure
          against wanting to review with others so any future implementation will have to be
    ...
    <details class="question" name="faq">
      ...
      <div class="answer">
        <p>
          ...
          typically are only a couple of users online at any given time. There are a few
          alternatives:
        </p>
        <ol>
          <li>
            If you <a href="/account/preferences/ogs">connect an OGS account</a>, the quick play
            games generate unranked games on OGS and you can see other unranked games posted in
            Lobby. This is the best way to get a live game against another human.
          </li>
          <li>
            If you create a game, you can send that link to a friend and play even if they don't
            have an account.
          </li>
          <li>
            The site supports correspondence games where each player has some number of days to make
            a move. You can join an existing challenge or create a new one!
          </li>
    ...
    <details class="question" name="faq">
      ...
      <div class="answer">
        ...
        <p>
          That token can act as you to do things with the OGS API, which Libaduk uses for creating
          and joining games as you. The token is <em>mostly</em> stored in your browser but it does get
          used serverside in a few flows. I've tried to limit any storage of "secrets" on this site and
          hope to limit it even further.
        </p>
      </div>
    </details>
  </div>
